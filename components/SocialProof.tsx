...
const testimonials = [
    {
        name: "Abbas Khan",
        handle: "@abbas_crypto",
        text: "Nothing is more satisfying than good customer support. I had an issue with a deposit on @AuditPal and their team fixed it within 10 minutes. Bullish on AuditPal 🏦",
        image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Abbas",
        verified: true,
    },
    {
        name: "Farhaj Mayan",
        handle: "@farhaj_mayan",
        text: "I just setup a VISA platinum card that I topped up with SOL USDT and paid for Deliveroo using Apple Pay in 5 minutes!? I'm still in shock. This product is insane.",
        image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Farhaj",
        verified: true,
    },
    {
        name: "Slice",
        handle: "@slice_web3",
        text: "I have been looking for the most cost effective and easiest way to off ramp my Solana/USDC. AuditPal has solved all of this for me in one fell swoop.",
        image: "https://api.dicebear.com/7.x/avataaars/svg?seed=Slice",
        verified: true,
    },
    {
        name: "Alex Rivera",
        handle: "@alex_sec",
        text: "The multi-agent consensus is actually legit. AuditPal caught a reentrancy bug that three other tools missed. Flagship security.",
    ...
    return (
        ...
        >
            <div className="flex items-center gap-3 mb-4">
                ...
                <Twitter className="w-4 h-4 text-zinc-700 group-hover:text-kast-teal transition-colors flex-shrink-0" />
            </div>
