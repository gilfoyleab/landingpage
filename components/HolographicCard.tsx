                ...
                <div className="relative z-30 p-6 h-full flex flex-col justify-between">
                    ...
                    <div className="flex-1 flex items-end gap-1 py-4">
                        {[...Array(12)].map((_, i) => (
                            <div
                                key={i}
                                className="w-full bg-kast-teal/20 rounded-t-sm relative overflow-hidden"
                                style={{
                                    height: `${30 + Math.random() * 50}%`,
                                    animation: `barHeight 2s ease-in-out infinite alternate ${i * 0.1}s`
                                }}
                            >
                                <div className="absolute bottom-0 inset-x-0 h-full bg-gradient-to-t from-kast-teal/80 to-transparent opacity-50" />
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
                        ...
                        <div>
                            ...
                            <div className="text-white text-sm font-mono font-bold text-kast-teal">127</div>
                        </div>
                    </div>
                </div>
