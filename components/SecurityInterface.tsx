...
export function SecurityInterface() {
    ...
    return (
        <div className="relative w-[500px] h-[340px] perspective-[1000px] group">
            ...
            >
                ...
                <div className="flex-1 p-6 font-mono text-xs relative">
                    ...
                    <motion.div
                        ...
                        className="absolute left-0 right-0 h-[1px] bg-kast-teal shadow-[0_0_15px_#1EBA98] z-10 opacity-50"
                    />
            ...
            {/* Background Decor */}
            <div className="absolute -inset-4 bg-kast-teal/5 blur-2xl -z-10 rounded-full" />
        </div>
    );
}
